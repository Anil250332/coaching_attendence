...
const NewAdmissionModal: React.FC<NewAdmissionModalProps> = ({ isOpen, onClose }) => {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
              ...
              <div className="relative">
                <select className="w-full px-4 py-3 rounded-lg border border-gray-300 hover:border-gray-400 focus:border-blue-600 focus:ring-2 focus:ring-blue-100 outline-none transition-all text-[15px] font-medium text-gray-900 bg-gray-50 focus:bg-white cursor-pointer appearance-none">
